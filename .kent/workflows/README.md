...
- `Puber Release`: non-default schema-4 revision 88 release control plane
...
`Puber Release`, non-default identity, and revision 88 counts of 15 nodes,
42 transition groups, and 42 edges. The four deterministic nodes are
`release_intent_gate`, `ci_watch`, `merge_watch`, and `task_janitor`.
