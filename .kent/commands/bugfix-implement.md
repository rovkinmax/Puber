...
7. Do not execute runtime Smoke or another workflow-owned review/delivery item. If a legacy plan renders one as an
...
8. Do not run nested final reviewers, commit, or push. The generated workflow owns review and delivery.
