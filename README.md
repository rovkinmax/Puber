...
используется для экспериментального поиска сегментов intro/credits и получения расписания выхода серий; без него
соответствующие возможности будут недоступны или работать ограниченно.
